...
var createTable ='create table if not exists orders(id int unsigned auto_increment primary key, status enum("pending", "achieved") default "pending" null, userId int unsigned null, menuId int unsigned null, created_at datetime null);';
